...
export class Parser {
    ...
    async parseToEpisode() {
        ...
        //     return
        // }
        // const title = await this.translator.enToJaText(titleEl.textContent)
        // console.log(title)
        ...
        //     console.log("No category text")
        //     return
        // }
        // const category = await this.translator.enToJaText(categoryEl.textContent)
        // console.log(category)

        // // Need-to-know language… ~ Answer this…
        ...
        //     return
        // }
        // const question = await this.translator.enToJaText(questionEl.textContent)
    ...
    parseDate = (): Date => {
        ...
        const date = dateEl.innerHTML.split("/")[1].trim()
